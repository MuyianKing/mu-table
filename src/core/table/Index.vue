...
<template>
  <div :id="tableId" class="mu-table" :class="{ 'mu-table-border': border, 'mu-table-nowrap': nowrap && !refresh_layout }" :style="{ height: data.length === 0 ? '100%' : '' }">
